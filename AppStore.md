...
- Choose a meditation duration from 1–180 minutes
- Gentle end-of-session gong with adjustable volume
- Timer can continue counting after the goal is reached
- Optional Apple Health integration to write Mindfulness sessions
